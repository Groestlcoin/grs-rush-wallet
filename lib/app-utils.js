...
GLOBAL.dpc = function(t, fn) {
    if (typeof(t) == 'function') setTimeout(t, 0);
...
UTILS.Logger = function(options) {
    ...
    self.write = function(text) {
        try {
            ...
            console.log("Logger unable to append to log file:", ex);
        }
    }
