    ...
    return function e(t, n, r) {
        ...
        21: [function(require, module, exports) {
            ...
            Transaction.prototype.hashTransactionForSignature = function(connectedScript, inIndex, hashType) {
                ...
                console.log("buffer",buffer)
                var checksum = conv.hexToBytes(Module.ccall('GroestlCoinHash', 'string', ['string'], [conv.bytesToHex(buffer)]));
            ...
            Transaction.prototype.getHash = function() {
                ...
                console.log("buffer", buffer)
                var checksum = conv.hexToBytes(Module.ccall('GroestlCoinHash', 'string', ['string'], [conv.bytesToHex(buffer)])).slice(0, 4);
                return checksum;
                return Crypto.SHA256(Crypto.SHA256(buffer, {
                    asBytes: true
                }), {
